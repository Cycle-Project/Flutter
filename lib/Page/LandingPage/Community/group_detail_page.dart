      ...
      body: Stack(
        children: [
          ...
          Align(
            ...
            child: ImageAvatar(
              border: const ImageAvatarBorder(borderRadius: 0, thickness: 0),
              size: size.width,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Padding(
                        ...
                        child:
                            Header(title: "Members", padding: EdgeInsets.zero),
                      ),
                      InkWell(
                        onTap: () {},
                      ...
                      const Padding(
                        padding: EdgeInsets.symmetric(vertical: 16),
                        child:
                            Header(title: "Events", padding: EdgeInsets.zero),
                      ),
                      const _Events(),
                    ],
                  ),
